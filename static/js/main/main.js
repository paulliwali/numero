...
(function() {
  var BLOCK_DEFAULT_HEIGHT_PIXEL, BLOCK_DEFAULT_WIDTH_PIXEL, BOARD_SIZE_LARGE, BOARD_SIZE_MEDIUM, BOARD_SIZE_RANDOM, BOARD_SIZE_SMALL, Block, CLASS_ACTIVE, CLASS_GRID_BORDER, Condition, Dice, ELEMENT_BOARD_CONTAINER, ELEMENT_CONDITIONS_CONTAINER, ELEMENT_GAME_CONTAINER, ELEMENT_GAME_OPTIONS_BOARD_SIZE, ELEMENT_GAME_OPTIONS_CONTAINER, ELEMENT_GAME_OPTIONS_NUM_PLAYERS, Game, Grid, Orientation, Player, Position, Size, UNIT_BLOCK, UNIT_PIXEL, WinningConditions, addConditionInViewableBox, bindPlayerControls, randomNum, randomise, showError, showGameWin, showMessage, startGameMessage, stopPageScrolling,
