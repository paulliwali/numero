...
(function() {
  var BLOCK_DEFAULT_HEIGHT_PIXEL, BLOCK_DEFAULT_WIDTH_PIXEL, Block, Condition, Dice, ELEMENT_BOARD_CONTAINER, ELEMENT_GAME_CONTAINER, Orientation, Player, Position, Size, UNIT_BLOCK, UNIT_PIXEL, WinningConditions, randomNum, randomise,
  ...
  $(function() {
    var blockSize, condition, dice, diceElement, diceSize, grid, winningConditions;
